...
Optionally a palette can be specified as per hcl.colors from grDevices package.
...
However, your computer's processing power is probably too low for a snappy result; do so at own discretion.
