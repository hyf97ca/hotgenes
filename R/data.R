...
#'
#' A sample dataset processed following instructions from \url{https://bioinformatics-core-shared-training.github.io/RNAseq-R/align-and-count.nb.html}\cr
...
#'   \item{targets}{dataset listing. Only 1 is used in this featureCounts output: SRR1552455.1.fastq.subread.BAM which delineates the pipeline it went through previously:\cr
#'    fastq -> rsubread }
#'   \item{stat}{Statistics about this featureCounts run. Not used in this package, but is provided for completion.}
#' }
#' @source \url{https://www.ncbi.nlm.nih.gov/sra?term=SRX681996}<br/>
